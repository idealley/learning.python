...
# How to know FOR SURE how the inheritance will behave when we have multiple parents?
...
# or 
print(Square.mro()) #prints a list

# the mostlikely dynamic use is the first one, from an instance 
